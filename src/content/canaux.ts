...
export const CANAUX: Record<TypeId, string> = {
  ...
  reveur:
    "On te parle le mieux avec des consignes claires et beaucoup d'espace : on te dit posément ce qu'on attend, puis on te laisse le calme de t'y mettre à ton rythme. Tu reçois bien une demande simple et respectueuse, sans surenchère ni sollicitation pressante qui t'envahirait. Donne-toi une direction nette, du temps et de la tranquillité, et tu avanceras sans avoir besoin qu'on te relance.",
  rebelle:
